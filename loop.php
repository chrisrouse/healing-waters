		...
		<div class="title-wrap clearfix">
			<?php if( '' !== get_the_title() ) { ?>
				<?php if( is_single() || is_page() ) { ?>
					<div class="post-date" align="center"><span><?php the_time( 'l' ); ?></span><br><span><?php the_time( 'M d, Y' ); ?></span></div><h1 class="post-title entry-title"><?php the_title(); ?></h1>
				<?php } else { ?>
				<div class="post-date" align="center"><span><?php the_date( 'l' ); ?></span><br><span><?php the_time( 'M d, Y' ); ?></span></div><h1 class="post-title entry-title">
